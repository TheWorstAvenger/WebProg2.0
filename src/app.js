...
import GaragePage from "./garage/garage";
    ...
    class App {
        ...
        initRouter() {
            ...
            this._currentUrl = "";
            this._router.on({
                "AutoHinzufügen": () => { this.showAutoHinzufuegen(); },
                "GarageAnzeigen": () => { this.showGarageAnzeigen(); },
                "new": () => { this.showAddNewEntryPage(); },
                "start": () => { this.showStartPage(); },
                "overview": () => { this.showStartPage(); },
                "*": () => { this.showStartPage(); },
            });
        }
        ...
        showAutoHinzufuegen(){
          let view = new HinzufuegenPage(this);
          this._switchVisibleView(view);
        }

        showGarageAnzeigen(){
          let view = new GaragePage(this);
          this._switchVisibleView(view);
        }
